...
(function($) {
	...
	var getWidgetData = function(htmlElement){
	    ...
	    var widgetAttribute = new RegExp(/^data-(.*)/i),
	    	reservedKeywords = ['feature', 'action', 'method', 'confirm', 'with', 'method', 'remote', 'type', 'disable-with', 'actuate', 'target' , 'route'], //this is kind of a pain in the ass
			widgetData = {};
				...
				try {
	                ...
	                if (e instanceof TypeError) {  //todo: check cross browser compatibilities
	                    ...
	                    // if you see this error, this script is looking for $.fn.actionName to execute with the context of the object.
	                        console.error('jquery-ujs error, unfound jquery extend method: "' + widgetName + '"; or possible TypeError from within widget:');
                            console.error(e);
	                } else {
	                    throw(e);
	                }
